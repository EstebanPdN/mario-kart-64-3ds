...
static json_t *make(const char *tag, bool pre, bool homebrew) {
  ...
  snprintf(name,sizeof(name),"mk64-3ds-v%s.%s",v,homebrew?"3dsx":"cia");
...
int main(int argc,char **argv) {
 assert(Update_IsNewer("v1.6-E1", "1.5"));
 assert(Update_IsNewer("v1.6-E2", "1.6-E1"));
 assert(!Update_IsNewer("v1.5", "1.6-E1"));
 assert(Update_IsNewer("v1.6", "1.6-E1"));
 ...
 const char *built="mk64-3ds-v0.48.cia";
