...
Result AM_GetCiaFileInfo(int a,AM_TitleInfo*i,Handle h){i->titleID=wrong_title?123:0x0004000005a27000ull;return 0;}
...
int main(int argc,char**argv){
 ...
 status.state=UPDATE_INSTALLING;cancel=false;Updater_Cancel();assert(!cancel);
 status.state=UPDATE_VERIFYING;Updater_Cancel();assert(cancel);cancel=false;
