...
source = root / 'platform/3ds/update'
prefix = args.jansson_prefix.resolve()
with tempfile.TemporaryDirectory(prefix='mk64-updater-test-') as temporary:
    ...
    subprocess.run(common + [f'-DMK64_3DS_VERSION="{version}"', '-Wno-deprecated-declarations',
